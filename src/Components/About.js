...
<div>
    ...
    <div className='border-l-2 rounded-3xl'>
    ...
    <a className='py-2 px-6 transform hover:scale-110 duration-300 border border-indigo-600 text-indigo-600 ease-out hover:bg-indigo-600 rounded-full whitespace-nowrap xl:mr-8 mt-1 uppercase text-sm lg:text-sm hover:text-white' href='/about'>Read more</a>
    </div>
</div>
<div>
